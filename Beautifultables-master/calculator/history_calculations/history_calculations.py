...
from calculator.calculator_calculations.addition import Addition_calce
from calculator.calculator_calculations.subtraction import Subtraction_calce
from calculator.calculator_calculations.multiplication import Multiplication_calce
from calculator.calculator_calculations.division import Division_calce
...
class History:
    ...
    def add_addition_to_history(values):
        ...
        return History.add_calculation_to_history(Addition_calce.create(values).getresult())

    @staticmethod
    def add_subtraction_to_history(values):
        """ Adds subtraction to history """
        return History.add_calculation_to_history(Subtraction_calce.create(values).getresult())

    @staticmethod
    def add_multiplication_to_history(values):
        """ Adds multiplication to history """
        return History.add_calculation_to_history(Multiplication_calce.create(values).getresult())

    @staticmethod
    def add_division_to_history(values):
        """ Adds division to history """
        return History.add_calculation_to_history(Division_calce.create(values).getresult())
